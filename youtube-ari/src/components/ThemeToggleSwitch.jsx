  ...
  return (
    <div className="mr-2 px-2">
      <button
        ...
        className={`flex h-8 w-14 items-center rounded-full p-1 transition-colors duration-300 ${theme === "dark" ? "bg-ytGray-30 outline outline-1 outline-white" : "bg-gray-200"}`}
      >
        <div
