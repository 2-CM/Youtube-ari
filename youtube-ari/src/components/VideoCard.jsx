  ...
  return (
    <div className="relative mx-2 mb-8">
      <div className="flex h-full items-start justify-center">
        <div className="relative block w-full min-w-[327px] max-w-[700px]">
          <div className="relative flex h-full flex-col">
            ...
            <div className="relative flex flex-auto cursor-pointer flex-row">
              <div className="mr-3 mt-3 inline-block h-9">
                <a href="/">
              ...
              <div className="overflow-x-hidden pr-6">
                ...
                <div className="flex flex-col text-left text-sm text-ytGray-90">
                  ...
                  <div className="line-clamp-2 flex flex-row text-ellipsis">
                    <span>29K views </span>
                    <span className="ml-1">• 13 days ago</span>
                  </div>
                </div>
              </div>
              <div className="absolute -right-3 top-1">
                <button className="relative inline-block h-10 w-10 align-middle">
